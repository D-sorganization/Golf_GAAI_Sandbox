"""Terrain regions and patches for golf simulation.

Provides :class:`TerrainPatch` (axis-aligned rectangular regions) and
:class:`TerrainRegion` (circular or polygonal regions) — together these
describe where each :class:`~src.shared.python.physics.terrain_materials.TerrainType`
applies on the playing surface. Both classes serialize to / from dictionaries
...
__all__ = ["TerrainPatch", "TerrainRegion"]
