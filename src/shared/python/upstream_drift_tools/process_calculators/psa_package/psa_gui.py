...
class InputPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        op_group = self._create_operating_parameters_group()
        layout.addWidget(op_group)

        # Component Data Group
        comp_group = self._create_component_data_group()
    ...
    def _create_operating_parameters_group(self) -> QGroupBox:
    ...
    def _create_component_data_group(self) -> QGroupBox:
...
class ResultsPanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        safety_group = self._create_safety_metrics_group()
        layout.addWidget(safety_group)

        # Stream Flows Table
        flows_group = self._create_flows_group()
        layout.addWidget(flows_group)

        # Compositions Table
        comp_group = self._create_compositions_group()
        layout.addWidget(comp_group)
    ...
    def _create_safety_metrics_group(self) -> QGroupBox:
    ...
    def _create_flows_group(self) -> QGroupBox:
    ...
    def _create_compositions_group(self) -> QGroupBox:
