...
class UISetupMixin:
    ...
    def _create_generation_tab(self) -> QWidget:
        ...
        type_group = self._create_signal_type_group()
        layout.addWidget(type_group)

        self._create_parameter_stack()
    ...
    def _create_signal_type_group(self) -> QGroupBox:
        """Create the signal type selector group."""
    ...
    def _create_parameter_stack(self) -> None:
        """Prepare the parameter form stack."""
    ...
    def _create_time_range_group(self) -> QGroupBox:
        """Create the time range settings group."""
    ...
    def _create_differentiation_group(self) -> QGroupBox:
        """Create controls for taking signal derivatives."""
    ...
    def _create_integration_group(self) -> QGroupBox:
        """Create controls for signal integration."""
