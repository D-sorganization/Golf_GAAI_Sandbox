...
int main() {
  try {
    ...
    // A Free joint has six coordinates: (in order) rot_x, rot_y, rot_z,
    // trans_x, trans_y, trans_z Set the properties of the coordinates that
    // define the joint
    ...
    double stiffness = 1E7, dissipation = 0.1, staticFriction = 0.6,
           dynamicFriction = 0.4, viscosity = 0.01;
