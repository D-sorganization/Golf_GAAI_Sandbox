...
------------------------------------------------------------- */
    ...
    */
    ...
    /* -------------------------------------------------------------
       Adjust model forces after RRA completes, use mass-height-volume
       relationship
       ------------------------------------------------------------- */
    /*
    Model* osimModel = std::make_unique<auto>(Model("DOWNLOAD_DIR/RRA/run/subject_run_rra3.osim");
    ...
    scaleOptimalForceSubjectSpecific( osimModel, osimModelUpd, heightOriginal,
    heightNew ); setMaxContractionVelocityAllMuscles(osimModelUpd,15.0);
    ...
    */
    ...
    /*
     Model* osimModel = new
     Model("DOWNLOAD_DIR/RRA/walk/subject01_walk_rra1.osim");
    ...
    */
    ...
    /*
     Model* osimModel = new
     Model("DOWNLOAD_DIR/RRA/walk/subject_walk_rra2.osim");
  ...
  cout << "main() routine time = "
       << 1.e3 * (clock() - startTime) / CLOCKS_PER_SEC << "ms\n";
