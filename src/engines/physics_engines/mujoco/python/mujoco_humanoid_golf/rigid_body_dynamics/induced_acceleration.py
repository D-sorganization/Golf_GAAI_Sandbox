...
class MuJoCoInducedAccelerationAnalyzer:
    ...
    def compute_components(self, tau_app: np.ndarray | None = None) -> InducedAccelerationResult:
        ...
        rhs_stack = np.column_stack((-term_G, -term_C, tau_vec, self.data.qfrc_constraint))
