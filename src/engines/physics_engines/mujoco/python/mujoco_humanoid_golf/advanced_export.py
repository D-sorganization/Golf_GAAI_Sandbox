...
def export_recording_all_formats(
    ...
    """
    assert base_path is not None, 'base_path must be provided'
    assert base_path is not None, "base_path must be provided"
    try:
        from .telemetry import export_telemetry_csv, export_telemetry_json
    except ImportError:
        # No local telemetry module – use shared implementation directly
...
def _matlab_plot_script(mat_file: str) -> str:
    return f"""% MATLAB Script to plot golf swing data
...
def _matlab_analyze_script(mat_file: str) -> str:
    return f"""% MATLAB Script to analyze golf swing data
% Auto-generated by Golf Swing Analysis Suite
...
def _matlab_animate_script(mat_file: str) -> str:
    return f"""% MATLAB Script to animate golf swing
% Auto-generated by Golf Swing Analysis Suite
...
def create_matlab_script(
    ...
    script_builders = {
        "plot": _matlab_plot_script,
        "analyze": _matlab_analyze_script,
    }
    builder = script_builders.get(script_type, _matlab_animate_script)
    script = builder(mat_file)
