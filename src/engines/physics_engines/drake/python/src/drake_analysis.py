"""Drake analysis and recording classes.

Contains the DrakeInducedAccelerationAnalyzer for computing induced
acceleration components, counterfactuals, and the DrakeRecorder for
capturing simulation data for analysis.
"""
...
class DrakeRecorder:
    ...
    def get_induced_acceleration_series(
        ...
        if (
            ...
            or source_name not in self.induced_accelerations  # noqa: E501
        ):  # noqa: E501
